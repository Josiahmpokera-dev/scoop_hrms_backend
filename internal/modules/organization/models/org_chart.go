...
type OrgChartNode struct {
	...
	DepartmentID     *uint           `json:"departmentId"`     // Department ID (for linking)
	...
	IsDepartmentHead bool            `json:"isDepartmentHead"` // True if this employee is a department head
	HeadOfDepartments []DepartmentRef `json:"headOfDepartments,omitempty"` // Departments this person heads
	Subordinates     []OrgChartNode  `json:"subordinates"`     // Child nodes
}

// DepartmentRef is a lightweight reference to a department
