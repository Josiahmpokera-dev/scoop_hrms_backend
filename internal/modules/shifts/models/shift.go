...
type Shift struct {
	...
	LateThresholdTime string         `json:"late_threshold_time" gorm:"size:8"`  // HH:MM:SS format (exception time)
...
type CreateShiftRequest struct {
	...
	LateThresholdTime string   `json:"late_threshold_time"` // HH:MM:SS format
